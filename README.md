...
├── local\_agent\_1/                  # Target Agent

│   └── src/

│       ├── agent\_logic.py          # RAG pipeline + OTel instrumentation

│       ├── instrumentation.py      # OpenTelemetry provider initialization

│       └── main.py                 # Interactive shell interface

├── local\_agent\_2/                  # Sentinel Watchdog Agent

│   └── src/

│       ├── signoz\_client.py        # SigNoz Query API integration

│       ├── detectors/              # Metric analysis modules

│       └── main.py                 # Sentinel loop \& LLM reasoner

├── test\_run.py                     # E2E demonstration script
